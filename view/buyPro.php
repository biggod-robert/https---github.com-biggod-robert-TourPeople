...
<head>
    <title>Buy Pro TourPeople</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    <meta
        name="viewport"
    ...
    <main>
        <div class="container bg-light d-md-flex align-items-center">
            <div class="card box1 shadow-sm p-md-5 p-md-5 p-4">
                <div class="fw-bolder mb-4"><span class="fas fa-dollar-sign"></span><span class="ps-1">600,000</span></div>
                <div class="d-flex flex-column">
                    <div class="d-flex align-items-center justify-content-between text"> <span class="">Commission</span> <span class="fas fa-dollar-sign"><span class="ps-1">4900</span></span> </div>
                    <div class="d-flex align-items-center justify-content-between text mb-4"> <span>Total</span> <span class="fas fa-dollar-sign"><span class="ps-1">604.900</span></span> </div>
                ...
                <form action="">
                    <div class="row">
                        ...
                        <div class="col-12 px-md-5 px-4 mt-3">
                            <div class="btn btn-primary w-100 pay">Pay $600.000</div>
                        </div>
                    </div>
                </form>
            </div>
