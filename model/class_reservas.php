...
class ReservasManager
{
    ...
    public function gestionarTiposHabitaciones($conexion, $opcion, $idTipoHabitacion, $nombreTipo, $descripcionTipo, $precioPorNoche)
    {
        switch ($opcion) {
            ...
            case 2: // Insertar nuevo tipo de habitación
                return $this->insertarTipoHabitacion($conexion, $nombreTipo, $descripcionTipo, $precioPorNoche);
                break;
    ...
    public function insertarTipoHabitacion($conexion, $nombreTipo, $descripcionTipo, $precioPorNoche)
    {
